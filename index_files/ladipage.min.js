...
(LadiPageScriptV2.prototype.init = function () {
  ...
  (LadiPageScriptV2.prototype.run = function (t) {
    ...
    var d,
                ...
                r.type == e.const.DATA_ACTION_TYPE.link &&
                  ...
                  r.type == e.const.DATA_ACTION_TYPE.popup &&
                    t.addEventListener("click", function (a) {
                      if ("false" != t.getAttribute("data-click")) {
                        var n = document.getElementById(r.action);
                        e.isEmpty(n) || window.ladi(r.action).show(),
                          e.runEventTracking(i, !1);
                      }
                    }),
      ...
      k = function (t, i, a, n) {
        if (
          e.isEmpty(e.runtime.timeout_gallery[t]) &&
          ...
          if (!(e.isEmpty(r) || (e.runtime.tmp.gallery_playing_video && i))) {
            ...
            if (0 != o.length && 0 != o.length) {
              ...
              for (var p = 0; p < l.length; p++)
                (parseFloatLadiPage(l[p].getAttribute("data-index")) || 0) == c
                  ? l[p].classList.add("selected")
                  : l[p].classList.remove("selected");
              var m = e.getElementBoundingClientRect(r),
                g = e.getElementBoundingClientRect(
                  r.getElementsByClassName("ladi-gallery-control-item")[c]
                );
              if (
                r
                ...
                var y =
                    parseFloatLadiPage(
                      getComputedStyle(
                        r.getElementsByClassName("ladi-gallery-control")[0]
                      ).width
                    ) || 0,
                  _ =
                    parseFloatLadiPage(
                ...
                var h =
                  parseFloatLadiPage(
                    getComputedStyle(
                      r.getElementsByClassName("ladi-gallery-control-box")[0]
                    ).width
                  ) || 0;
                f <
                  (h =
      ...
      D = function (t, i, a) {
        ...
        var s = parseFloatLadiPage(t.target.getAttribute("data-index")) || 0,
          c = null,
          d = null;
        (parseFloatLadiPage(a.getAttribute("data-current")) || 0) > s
          ? ((c = "prev"), (d = "right"))
          : ((c = "next"), (d = "left"));
        var u = a.getAttribute("data-is-next") || "true";
        (u = "true" == u.toLowerCase()) ? s-- : s++,
          a.setAttribute("data-current", s),
          a.setAttribute("data-next-time", Date.now() + 1e3 * l),
          k(i, !1, c, d);
      },
      R = function (t, i) {
        if (
          ...
          if (1 != i)
            for (
              var a = document.querySelectorAll(
                  ".ladi-paragraph, .ladi-list-paragraph, .ladi-headline, .ladi-countdown, .ladi-form"
                ),
                n = 0;
              n < a.length;
              n++
              ...
              if (!e.isEmpty(o)) {
                ...
                if (!e.isEmpty(l)) {
                  ...
                  if (!e.isEmpty(s) && !e.isEmpty(c)) {
                    var d = e.generateVariantProduct(
                      n,
                      !0,
                      l["option.product_variant_type"],
                      l["option.product_variant_title"],
                      l["option.product_variant_price"],
                      l["option.input_tabindex"],
                      t,
                      !0,
                      function (t) {
                        M(i, a);
                      ...
                      e.showParentVisibility(o, function () {
                        for (
                          var t = o.clientHeight,
                            i = t,
                            a = o.querySelectorAll("select.ladi-form-control"),
                            s = {},
                            c = 0;
                          c < a.length;
                          c++
                          ...
                          s[
                            a[c].getAttribute("data-store-id") +
                              ...
                              "_" +
                              a[c].getAttribute("data-product-variant-id")
                          ] = a[c].value;
                        o.innerHTML = d;
                        for (
                          ...
                          var m =
                            s[
                              u[p].getAttribute("data-store-id") +
                                ...
                                "_" +
                                u[p].getAttribute("data-product-variant-id")
                            ];
                          if (e.isNull(m)) {
                        ...
                        if (
                          ...
                          o.style.setProperty("height", "auto"),
                            ...
                            t != i &&
                              ...
                              e.updateHeightElement(!0, o, r, t, i));
                        else if (!e.isEmpty(n["option.product_variant_id"]))
                          for (var y = 0; y < u.length; y++) {
                            var _ = u[y].querySelector(
                              'option[data-product-variant-id="' +
                                n["option.product_variant_id"] +
                                '"]'
                            );
                            e.isEmpty(_) ||
                              u[y].value == _.getAttribute("value") ||
                              ((u[y].value = _.getAttribute("value")),
                              e.fireEvent(u[y], "change"));
                          }
                      });
                  }
                }
      ...
      F = function (i, a, n) {
        ...
        if (
          !(
            e.isEmpty(r) ||
            e.isEmpty(r["option.product_type"]) ||
            e.isEmpty(r["option.product_id"]) ||
            e.isEmpty(r["option.product_mapping_name"])
          )
        ) {
          ...
          if (!e.isEmpty(n) && e.isEmpty(l)) {
            ...
            var s = e.generateVariantProduct(
              r,
              !1,
              null,
              null,
          ...
          if (o !== c) {
            var d = null,
              ...
              p = null;
            if (
              (("headline" != a && "paragraph" != a) || window.ladi(i).value(c),
              "image" == a)
            ) {
            ...
            if ("gallery" == a) {
              ...
              if (((d = document.getElementById(i)), e.isEmpty(d))) return;
              for (
                var g = d.getElementsByClassName("ladi-gallery-view-item");
                g.length < c.length;

              ) {
                var y = e.createTmpElement(
                  "div",
              ...
              for (; g.length > c.length; )
                g[g.length - 1].parentElement.removeChild(g[g.length - 1]);
              for (
              ...
              for (; _.length > c.length; )
                _[_.length - 1].parentElement.removeChild(_[_.length - 1]);
                                    ...
                                    if (e.isString(E.option_ids))
                                      for (
                                        ...
                                        (v = document.querySelector(
                                          "#" +
                                            m[g].id +
                                            ' .ladi-form-item select[data-product-variant-id="' +
                                            L[P] +
                                            '"]'
                                        )),
                                          e.isEmpty(v) ||
          ...
          ? (!(function (t, i, a, n, r, o) {
            ...
            (function (t, i, a, n, r, o, l) {
              if ("countdown" == i && !e.isEmpty(a)) {
                ...
                e.isEmpty(s) ||
                  ...
                  a != e.const.COUNTDOWN_TYPE.countdown ||
                    e.isEmpty(n) ||
                    s.setAttribute("data-minute", n),
                  a != e.const.COUNTDOWN_TYPE.endtime ||
                    e.isEmpty(l) ||
                    s.setAttribute("data-endtime", l),
                  a != e.const.COUNTDOWN_TYPE.daily ||
                    e.isEmpty(r) ||
                    e.isEmpty(o) ||
                    (s.setAttribute("data-daily-start", r),
            ...
            (function (t, i) {
              if ("gallery" == i) {
                var a = document.getElementById(t);
                if (!e.isEmpty(a)) {
                  var n = a.getElementsByClassName(
                  ...
                  if (n > 0) {
                    ...
                    if (n <= 1)
                      for (
                        ...
                        c[d].classList.add("ladi-hidden");
                    a.setAttribute("data-current", 0),
                    ...
                    if (!e.isEmpty(r)) {
                        ...
                        if (!e.isEmpty(i.target.value)) {
                          ...
                          if (
                            ...
                            if (-1 != r) {
                              ...
                              s <= 0 &&
                                ((s = 0),
                                (0 == n.product.variants[r].inventory_checked ||
                                  l > 0) &&
                                  (s = 1),
                                (i.target.value = s)),
                                1 == n.product.variants[r].inventory_checked &&
                                  (s > l || 0 == l) &&
                                  (i.target.value = l);
                            }
                          }
                      ...
                      e.isEmpty(l) ||
                        ...
                        (l.addEventListener("click", function (t) {
                          (r.value = (parseFloatLadiPage(r.value) || 0) - 1),
                            e.fireEvent(r, "input");
                        }),
                ...
                if (!e.isEmpty(a)) {
                  ...
                  if (!e.isEmpty(n)) {
                    ...
                    if (
                      ...
                      (s.className =
                        "ladi-collection-arrow ladi-collection-arrow-right"),
                        o.appendChild(l),
                        o.appendChild(s),
      ...
      (function () {
        var i,
          ...
          A = function (t, i) {
            ...
            for (var v = 0; v < a.length; v++) {
              if (
                ...
                a[v].required && -1 == m.indexOf(d) && m.push(d),
                "INPUT" == a[v].tagName)
              ) {
          ...
          N = function (i, a, r, o, f) {
            (y = e.getURLSearchParams(window.location.search)),
              (n = {}),
              (l = {}),
              (s = {}),
              (c = []),
            ...
            if (!e.isEmpty(h)) {
              ...
              if (!e.isEmpty(v)) {
                ...
                (d = v["option.form_config_id"]),
                  (u =
                    parseFloatLadiPage(v["option.form_purchase_value"]) || 0),
              ...
              if (r) {
                ...
                return a.captcha &&
                  ...
                  : void w(r, o, function (t) {
                      ...
                      (!e.isEmpty(
                        e.runtime.tmp.capture_form_data_last[o + "_" + f]
                      ) &&
                        e.equals(
                          e.runtime.tmp.capture_form_data_last[o + "_" + f],
                          a
                                ...
                                (function (t, i) {
                                  ...
                                  !(function () {
                                    ...
                                    if (!M || e.isEmpty(C)) {
                                      if (
                                        (x ==
                                          e.const.FORM_THANKYOU_TYPE.default &&
                                          (e.isEmpty(D) || e.showMessage(D, s)),
                                        x == e.const.FORM_THANKYOU_TYPE.popup &&
                                          (B &&
                                          ...
                                          window.ladi(D).show()),
                                        x == e.const.FORM_THANKYOU_TYPE.url &&
                                          !e.isEmpty(D))
                                      ) {
            ...
            if (!e.isEmpty(i)) {
              ...
              if (-1 == n) {
                ...
                e.isEmpty(l) ||
                  ...
                  (o = L(i.id, l["option.form_config_id"])),
                  N(i, { captcha: !0 }, !1, o);
              } else {
                ...
                if (s.length > 0) {
                  ...
                  for (var c = 0; c < s.length; c++)
                    s[c].removeEventListener("change", k),
                      s[c].addEventListener("change", k);
          ...
          D = function (t, i, a, n) {
            ...
            if (!e.isEmpty(r)) {
              ...
              if (
                ...
                var l = function () {
                  var t = e.generateVariantProduct(
                    a,
                    !1,
                    null,
                    null,
                  ...
                  if (
                    ...
                    if (-1 != r) {
                      ...
                      var u = t.product.name,
                        ...
                        y = e.isEmpty(t.product.variants[r].src)
                          ? ""
                          : t.product.variants[r].src;
                      e.isEmpty(y) ||
                        (y = "https://" + e.const.STATIC_W_DOMAIN + "/" + y);
                      ...
                      if (e.isEmpty(h) || e.isEmpty(h.value))
                        ...
                        if (
                          (1 == t.product.variants[r].inventory_checked &&
                            e.runtime.tmp.cart[_].quantity + v > g &&
                            (v = g - e.runtime.tmp.cart[_].quantity),
                          v > 0)
                        ) {
                          var E = function () {
                            (e.runtime.tmp.cart[_].quantity += v),
                              e.addCartCookie(
                                ...
                                function (t) {
                                  (e.runtime.tmp.cart[_].quantity -= v),
                                    f && e.runtime.tmp.cart.splice(_, 1),
                          ...
                          if (
                            ...
                            if (e.runtime.tmp.is_click_add_to_cart) {
                              ...
                              (e.runtime.tmp.is_click_add_to_cart = !0), E();
                          else E();
                        } else
                          e.showMessage(e.const.LANG.ADD_TO_CART_NO_QUANTITY);
                      }
          ...
          F = {};
        f.forEach(function (t) {
          (F[t] = window.ladi("_ladipage_" + t).get_cookie()),
            e.isEmpty(o[t]) || (F[t] = o[t]);
        }),
          (i = r(F));
        var V = 0,
          Y = !1,
        ...
        for (V = 0; V < a.length; V++) {
          a[V].onsubmit = x;
          for (
            var H = e.findAncestor(a[V], "ladi-element"),
              U = a[V].getElementsByClassName("ladi-button"),
              j = 0;
            j < U.length;
            j++
          ) {
            ...
            if (!e.isEmpty(G)) {
              ...
              e.isEmpty(H) ||
              e.isEmpty(e.runtime.eventData[H.id]) ||
              !e.runtime.eventData[H.id]["option.is_add_to_cart"]
                ? W.addEventListener("click", B)
                : (W.setAttribute("data-click", !1),
                  W.addEventListener("click", R));
            }
          }
          var z = a[V].querySelector(
            '[data-is-select-country="true"][name="country"]'
          );
          if (
            !e.isEmpty(z) &&
            -1 != ["TH", "MY"].indexOf(z.value.split(":")[0])
          ) {
            var X = a[V].querySelector(
              'select[data-is-select-country="true"][name="ward"]'
            );
            e.isEmpty(X) || X.removeAttribute("required");
          }
          for (
            var J = a[V].querySelectorAll("[tabindex]"), K = 0, Z = 0;
            Z < J.length;
            Z++
          ) {
            var $ = parseInt(J[Z].getAttribute("tabindex")) || 0;
            $ > K && (K = $),
              J[Z].setAttribute("tabindex", e.runtime.tabindexForm + $);
          }
          e.runtime.tabindexForm += K;
          for (var Q = 0; Q < h.length; Q++) {
            var tt = a[V].querySelector(
          ...
          if ("countdown" == e.runtime.eventData[t].type) {
            ...
            if (!e.isEmpty(i)) {
              var a = i.getAttribute("data-type"),
                ...
                o = Date.now();
              if (
                i.hasAttribute("data-date-start") ||
                i.hasAttribute("data-date-end")
              )
                (n =
                  parseFloatLadiPage(i.getAttribute("data-date-start")) || 0),
                  (r =
                    parseFloatLadiPage(i.getAttribute("data-date-end")) || 0);
              else {
                ...
                if (
                  (a == e.const.COUNTDOWN_TYPE.endtime &&
                    (r = parseInt(i.getAttribute("data-endtime")) || 0),
                  a == e.const.COUNTDOWN_TYPE.daily)
                ) {
                  ...
                  if (!e.isEmpty(s) && !e.isEmpty(c)) {
                    ...
                    (n = new Date(d + " " + s).getTime()),
                      (r = new Date(d + " " + c).getTime());
                  }
                }
                i.setAttribute("data-date-start", n),
              ...
              if (!(n > o)) {
                ...
                u < 0 && (u = 0);
                for (
                  var p = e.getCountdownTime(u),
                    m = i.querySelectorAll("[data-item-type]"),
                    g = 0;
                  g < m.length;
                  g++
                )
                  m[g].querySelectorAll(
                    ".ladi-countdown-text span"
                  )[0].textContent = p[m[g].getAttribute("data-item-type")];
              }
            }
          }
        });
      ...
      p.forEach(function (t) {
        ...
        if ("gallery" == i.type) {
          ...
          if (!e.isEmpty(a)) {
            ...
            var l = function (e) {
              ...
              s = function (i) {
                i.stopPropagation(),
                  ...
                  e.isEmpty(e.runtime.timeout_gallery[t]) &&
                    ((e.runtime.current_element_mouse_down_gallery_view = t),
            ...
            for (
              var d = a.getElementsByClassName("ladi-gallery-control-item"),
                u = 0;
              u < d.length;
              u++
            )
        ...
        p.forEach(function (t) {
          ...
          if ("gallery" == i.type) {
            ...
            if (!e.isEmpty(a) && "true" == a.getAttribute("data-scrolled")) {
              var n = i[e.runtime.device + ".option.gallery_control.autoplay"],
                r =
                  i[e.runtime.device + ".option.gallery_control.autoplay_time"],
                o = 0;
              if ((n && !e.isEmpty(r) && (o = r), o > 0)) {
                ...
                e.isEmpty(l) &&
                  ...
                  s >= l &&
                    (k(t, !0), a.setAttribute("data-next-time", s + 1e3 * o));
              }
            }
          }
        });
            ...
            if (!e.isEmpty(a) && "true" == a.getAttribute("data-scrolled")) {
              ...
              if ((n && !e.isEmpty(r) && (o = r), o > 0)) {
                ...
                e.isEmpty(l) &&
                  ...
                  a.setAttribute("data-next-time", l)),
                  s >= l &&
                    (R(t, !0), a.setAttribute("data-next-time", s + 1e3 * o));
              }
            }
          }
        });
        ...
        for (
          ...
          for (
            var y = document.querySelectorAll(
                "#" +
                  e.runtime.tmp.list_form_checkout[g] +
            ...
            -1 != t.indexOf(y[_].getAttribute("name")) &&
              (y[_].addEventListener("change", m),
              y[_].addEventListener("input", m));
      })(),
      (function () {
        p.forEach(function (t) {
          var i = e.runtime.eventData[t];
  ...
  (LadiPageScriptV2.prototype.reloadLazyload = function () {
    ...
    t instanceof LadiPageScriptV2 || (t = LadiPageScript);
    for (
      var e = document.getElementsByClassName("ladi-lazyload"), i = [], a = 0;
      a < e.length;
      a++
    ) {
      var n = t.getElementBoundingClientRect(e[a]).y + window.scrollY;
      window.scrollY + t.getHeightDevice() > n &&
        n + e[a].offsetHeight > window.scrollY &&
        i.push(e[a]);
    }
    ...
    for (
      ...
      if (t.isEmpty(r[o].getAttribute("data-lazyload"))) {
        ...
        for (
          var l = r[o].parentElement.getElementsByClassName("ladi-lazyload");
          l.length > 0;
  ...
  (LadiPageScriptV2.prototype.documentLoaded = function () {
    ...
    if (
      ...
      document.addEventListener("scroll", p),
        ...
        t.runTimeout(p, t.runtime.tracking_global_delay);
    }
  }),
      ...
      for (var n = t.substr(1).split("&"), r = 0; r < n.length; ++r) {
        ...
        this.isNull(a[o[0]])
          ...
          : i &&
            ...
            1 == o.length
              ? a[o[0]].push("")
              : a[o[0]].push(decodeURIComponent(o[1].replace(/\+/g, " "))));
      }
      ...
      if (
        (Object.keys(e.runtime.eventData).forEach(function (t) {
          var a = e.runtime.eventData[t],
            ...
            l = null;
          if (
            -1 != Object.keys(e.runtime.list_scroll_func).indexOf(t) &&
            ...
            "section" == a.type
              ? ((o = n.offsetTop),
                ((window.scrollY >= o &&
                  window.scrollY <= o + n.offsetHeight) ||
              ...
              : ((o = e.getElementBoundingClientRect(n).y + window.scrollY),
                ((window.scrollY >= o &&
                  window.scrollY <= o + n.offsetHeight) ||
                  (window.scrollY + e.getHeightDevice(!0) >= o &&
                  ...
                  (c = !0)),
              c &&
                ((l = e.runtime.list_scroll_func[t]),
                delete e.runtime.list_scroll_func[t],
                l());
          }
          ...
          if (
            ...
            !e.isEmpty(n) && !n.classList.contains("ladi-animation"))
          ) {
            var u =
              parseFloatLadiPage(
            ...
            var p =
              ...
              (window.scrollY + e.getHeightDevice(!0) >= o &&
                window.scrollY + e.getHeightDevice(!0) <= o + n.offsetHeight) ||
              (o >= window.scrollY &&
                window.scrollY + e.getHeightDevice(!0) >= o);
            e.runtime.tmp.isFirstScroll &&
              u > 0 &&
              !p &&
              n.classList.add("ladi-animation-hidden"),
              p &&
          ...
          if (e.isEmpty(i) || -1 != r.indexOf(t)) {
            ...
            if (
              ...
              if (
                !e.isEmpty(_) &&
                -1 != ["default", "top", "bottom"].indexOf(m)
              ) {
                var f = e.getElementBoundingClientRect(_),
                  h = _.getAttribute("data-top"),
                  v = _.getAttribute("data-left");
                e.isEmpty(h)
                  ? (_.setAttribute("data-top", f.y + window.scrollY),
                    (h = f.y))
                  : (h = parseFloatLadiPage(h)),
                  e.isEmpty(v)
                    ? (_.setAttribute("data-left", f.x + window.scrollX),
                      (v = f.x))
                    : (v = parseFloatLadiPage(v));
                var E = null,
                  L = null;
                if (
                  ("default" == m &&
                    (g > h - window.scrollY
                      ? ((E = g + "px"), (L = v + "px"))
                      : e.getHeightDevice() - y - _.clientHeight <
                          h - window.scrollY &&
                        ((E = "calc(100% - " + (y + _.clientHeight) + "px)"),
                        (L = v + "px"))),
                  "top" == m &&
                    (g > h - window.scrollY ||
                      e.getHeightDevice() - 0 < h - window.scrollY) &&
                    ((E = g + "px"), (L = v + "px")),
                  "bottom" == m &&
                    (e.getHeightDevice() - y - _.clientHeight <
                      h - window.scrollY ||
                      0 > h + _.clientHeight - window.scrollY) &&
                    ((E = "calc(100% - " + (y + _.clientHeight) + "px)"),
                    (L = v + "px")),
                  e.isEmpty(E) || e.isEmpty(L))
                )
                  _.style.removeProperty("top"),
                    _.style.removeProperty("left"),
                    _.style.removeProperty("width"),
                    _.style.removeProperty("position"),
                    _.style.removeProperty("z-index");
                else if (
                  ...
                  "section" == a.type &&
                    (e.runtime.isMobileOnly
                      ...
                      : s && _.style.setProperty("width", "100%")),
                  _.style.setProperty("position", "fixed"),
                  _.style.setProperty("z-index", "90000050"),
                  !_.hasAttribute("data-sticky"))
                ) {
                  _.setAttribute("data-sticky", !0),
                    _.classList.contains("ladi-animation-hidden") &&
                      (_.classList.remove("ladi-animation-hidden"),
                      _.classList.add("ladi-animation"));
                  for (
                    var P = _.getElementsByClassName("ladi-animation-hidden");
                    P.length > 0;

                  )
                    P[0].classList.add("ladi-animation"),
                      P[0].classList.remove("ladi-animation-hidden");
                  _.classList.remove("ladi-lazyload");
                  for (
                    var A = _.getElementsByClassName("ladi-lazyload");
                    A.length > 0;

                  )
                    A[0].classList.remove("ladi-lazyload");
                }
              }
            }
          }
    ...
    if (this.runtime.isClient && !this.isEmpty(t)) {
      ...
      if (
        ...
        if (!this.isEmpty(m)) {
          ...
          this.isFunction(g.getEventTrackingCategory) &&
            (p = m(i, this.runtime.isClient).getEventTrackingCategory());
        }
        var y = {
          event_category: p,
          event_label: window.location.host + window.location.pathname,
        };
        this.isEmpty(s) || this.isEmpty(c) || ((y.value = s), (y.currency = c)),
          window.gtag("event", n, y);
      }
    ...
    if (!r.isEmpty(d) && "collection" == d.type) {
      var u = this.runtime.isDesktop ? this.const.DESKTOP : this.const.MOBILE,
            ...
            r.showParentVisibility(e, function () {
              for (
                var t = e.clientHeight,
                  i = t,
                  n = e.querySelectorAll("select.ladi-form-control"),
                  o = {},
                  c = 0;
                c < n.length;
                c++
                ...
                o[
                  n[c].getAttribute("data-store-id") +
                    "_" +
                    n[c].getAttribute("data-product-id") +
                    "_" +
                    n[c].getAttribute("data-product-variant-id")
                ] = n[c].value;
              e.innerHTML = l;
              for (
                var d = e.querySelectorAll("select.ladi-form-control"), u = 0;
                u < d.length;
                u++
              ) {
                d[u].removeEventListener("change", s),
                  d[u].addEventListener("change", s);
                var p =
                  o[
                    d[u].getAttribute("data-store-id") +
                      "_" +
                      d[u].getAttribute("data-product-id") +
                      "_" +
                      d[u].getAttribute("data-product-variant-id")
                  ];
                if (r.isNull(p)) {
              ...
              if (
                ...
                r.isEmpty(g) ||
                  ...
                  r.updateHeightElement(!0, e, g, t, i));
              }
            });
          }
        ...
        y = function (t, e, i, a) {
          ...
          if (
            ("headline" == c &&
              ((d = t.getElementsByClassName("ladi-headline")[0]),
              r.isEmpty(d) || (d.innerHTML = l)),
            "paragraph" == c &&
              ((d = t.getElementsByClassName("ladi-paragraph")[0]),
              r.isEmpty(d) || (d.innerHTML = l)),
            "image" == c)
          ) {
            s = r.getOptimizeImage(
              l,
              t.clientWidth,
              t.clientHeight,
              !0,
            ...
            r.isEmpty(u) ||
              (r.isEmpty(s)
                ? u.style.setProperty("background-image", "none")
                : u.style.setProperty("background-image", 'url("' + s + '")'));
          }
        },
        _ = function (t, e) {
          var d = p * m,
          ...
          if (r.isObject(u) && r.isArray(u.products)) {
            ...
            if (f.hasAttribute("data-max-option-length"))
              P = parseFloatLadiPage(f.getAttribute("data-max-option-length"));
            else {
            ...
            for (
              var C = b.getElementsByClassName("ladi-collection-page");
              C.length < i;
            ...
            if (N.length != u.products.length)
              for (; N.length > 0; ) N[0].parentElement.removeChild(N[0]);
              ...
              for (var d = 0; d < t.length; d++) {
                ...
                r.isEmpty(u) ||
                  ...
                  r.isFunction(r.runtime.tmp.runOptionAction) &&
                    r.runtime.tmp.runOptionAction(t[d], t[d].id, u.type, u),
                  ...
                  a && g(t, t[d], e, u, i, k),
                  r.isEmpty(u["option.product_mapping_name"]) ||
                    y(t[d], u, n, c));
              }
            };
            for (A = 0; A < u.products.length; A++)
              r.isArray(u.products[A].options) &&
                u.products[A].options.length > P &&
                (P = u.products[A].options.length);
            for (
              f.setAttribute("data-max-option-length", P), A = 0;
              A < u.products.length;
              A++
            )
              if (!(N.length > A)) {
                ...
                for (
                  var D = x.getElementsByClassName("ladi-element");
                  r.isArray(u.products[A].options) &&
                  u.products[A].options.length < P;

                )
                  u.products[A].options.push({ is_tmp: !0 });
    ...
    if (!this.isEmpty(a)) {
      ...
      if (
        ...
        for (
          ...
          c[s[d].getAttribute("data-product-variant-id")] = (
            s[d].value || ""
          ).trim();
            ...
            if (
              ...
              -1 != ["image"].indexOf(s) &&
                ...
                o.isObject(u) &&
                  ((t = u.src),
                  o.isEmpty(t) ||
                    (t = "https://" + o.const.STATIC_W_DOMAIN + "/" + t))),
              -1 != ["images"].indexOf(s) &&
                ((u = c.product[s]),
                o.isArray(u) &&
                  ((t = []),
                  u.forEach(function (e) {
                    o.isEmpty(e.src) ||
                      t.push({
                        src: "https://" + o.const.STATIC_W_DOMAIN + "/" + e.src,
                      });
                  }))),
              ...
              if (
                ...
                if (
                  ...
                  -1 != ["title"].indexOf(s) &&
                    ((u = g[s] || g.product_name), (t = u)),
                  -1 != ["text_quantity"].indexOf(s) &&
                    ((u = 1 == g.inventory_checked ? g[s] : ""), (t = u)),
                  -1 != ["weight"].indexOf(s) &&
                    ((u = g[s]),
                    o.isEmpty(g.weight_unit) || (u += g.weight_unit),
                    (t = u)),
                  -1 != ["price"].indexOf(s) &&
                    ((u = o.formatNumber(g[s], 3)),
                    o.isObject(c.store_info) &&
                      o.isObject(c.store_info.currency) &&
                      !o.isEmpty(c.store_info.currency.symbol) &&
                      (u = o.formatCurrency(
                        g[s],
                        c.store_info.currency.symbol,
                        !0
                      )),
                    (t = u)),
                  -1 != ["src"].indexOf(s))
                ...
                -1 != ["description"].indexOf(s) &&
                  ((u = g[s]), o.isEmpty(u) || (t = u));
              } else t = u = "";
            }
            if (-1 != ["description"].indexOf(s) && o.isEmpty(t))
              return (s = "content"), p();
          } else {
            if (((u = c.product[s]), o.isBoolean(u)))
              u = u ? o.const.LANG.OPTION_TRUE : o.const.LANG.OPTION_FALSE;
            else
              try {
                var y = new Date(u);
                y.toISOString() == u &&
  ...
  (LadiPageScriptV2.prototype.generateVariantProduct = function (
    ...
    if (u == d.const.FORM_CONFIG_TYPE.ladisales) {
      if (!d.isEmpty(m) && !d.isEmpty(p)) {
        if (
          (d.isEmpty(d.runtime.tmp.product_info[p]) &&
            (d.runtime.tmp.product_info[p] = {}),
          d.isEmpty(d.runtime.tmp.timeout_product_info[p]) &&
            (d.runtime.tmp.timeout_product_info[p] = {}),
          (m = parseInt(m) || m),
                ...
                d.isArray(h.product.variants) &&
                  h.product.variants.forEach(function (e, i) {
                    ...
                    if (n) {
                      ...
                      d.isObject(h.store_info) &&
                        d.isObject(h.store_info.currency) &&
                        !d.isEmpty(h.store_info.currency.symbol) &&
                        (r = d.formatCurrency(
                          e.price,
                          h.store_info.currency.symbol,
                          !0
                        )),
                        (a += " - " + r);
                    }
          ...
          return (
            d.sendRequest(
              ...
              JSON.stringify(E),
              !0,
              { "Content-Type": "application/json", "Store-Id": p },
              function (t, e, i) {
                if (i.readyState == XMLHttpRequest.DONE)
                  try {
                    if (d.isObject(d.runtime.tmp.product_info[p][m]))
                      h = d.runtime.tmp.product_info[p][m];
                    else {
                      var a = JSON.parse(t);
                      h = a.data;
                    ...
                    d.isObject(h)
                      ? ((d.runtime.tmp.product_info[p][m] = h),
                        (c = v()),
                        d.isFunction(s) && s(c))
                      : ((d.runtime.tmp.product_info[p][m] = !1),
                        d.isEmpty(d.runtime.tmp.timeout_product_info[p][m]) ||
                          (d.removeTimeout(
                            d.runtime.tmp.timeout_product_info[p][m]
                          ),
                          delete d.runtime.tmp.timeout_product_info[p][m]));
                  } catch (t) {
                    (d.runtime.tmp.product_info[p][m] = !1),
                      d.isEmpty(d.runtime.tmp.timeout_product_info[p][m]) ||
                        (d.removeTimeout(
        ...
        !0 === h
          ? (d.runtime.tmp.timeout_product_info[p][m] = d.runTimeout(
              function () {
  ...
  (LadiPageScriptV2.prototype.getCartCheckoutPrice = function (t) {
    return this.isArray(this.runtime.tmp.cart) &&
      this.runtime.tmp.cart.length > 0
    ...
    if (!LadiPageScript.isEmpty(t)) {
      ...
      try {
        if (!LadiPageScript.isNull(window.jQuery))
          return void $("html, body").animate({ scrollTop: $(t).offset().top });
        a();
      } catch (t) {
        a();
      }
